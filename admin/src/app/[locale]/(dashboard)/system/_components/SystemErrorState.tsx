...
export default function SystemErrorState() {
  return (
    <div>
      ...
      <div className="relative overflow-hidden rounded-xl border border-danger/20 bg-white shadow-[0_1px_4px_0_rgb(0_0_0/.05)]">
        <div className="h-[3px] bg-danger" />
        <div className="px-8 py-12 text-center">
          <div className="w-12 h-12 rounded-xl bg-danger/8 border border-danger/15 flex items-center justify-center mx-auto mb-4">
